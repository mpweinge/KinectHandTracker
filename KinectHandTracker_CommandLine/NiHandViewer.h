...
public:
    ...
    void setHandStartingLocations(XnSkeletonJointTransformation _leftHand,
                                  XnSkeletonJointTransformation _rightHand)
    {
        startingLeftHand = _leftHand;
        startingRightHand = _rightHand;
    }
protected:
...
private:
    ...
    XnSkeletonJointTransformation startingLeftHand;
    XnSkeletonJointTransformation startingRightHand;
};
